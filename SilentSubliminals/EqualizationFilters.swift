...
struct EqualizationFilters {
    ...
    static let biquadHighPass: [Double] = {
        let b0 = 0.018510833168003882
        let b1 = 1.6742539186051173
        let b2 = 0.7482972512771328
        let a1 = -0.037021666336007765
        let a2 = 0.018510833168003882
