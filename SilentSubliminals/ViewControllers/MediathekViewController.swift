...
class MediathekViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    
    var recentSubliminalItems = ["meditation_01", "meditation_02", "meditation_03", "meditation_04", "meditation_05"]
    var playlistItems = ["plusSymbolGreen", "meditation_06", "meditation_07", "meditation_08", "meditation_09"]
